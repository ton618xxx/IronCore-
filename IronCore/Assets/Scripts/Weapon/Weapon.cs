...
public class Weapon
{
    ...
    public float reloadSpeed { get; private set; }       // how fast we reload the weapon.   
    public float equipmentSpeed { get; private set; }    // how fast we equip the weapon.
    public float gunDistance { get; private set; }      // how far the gun can shoot.
    public float cameraDistance { get; private set; }   // how far the camera is from the player when this weapon is equipped.   
    #endregion
    ...
    public Weapon(Weapon_Data weaponData)
    {
        ...
        burstBulletsPerShot = weaponData.burstBulletPerShot; 
