...
public class PlayerWeaponVisuals : MonoBehaviour
{
    ...
    public void SwitchOnBackupWeaponModel()
    {
        ...
        foreach (BackupWeaponModel backupModel in backupWeaponModels)
        {
            ...
            if (player.weapon.WeaponInSlots(backupModel.weaponType) !=null)
            {
               ...
               if (backupModel.HangTypeIs(HangType.SideHand))
    ...
    {
        Transform targetTrasnform = CurrentWeaponModel().holdPoint;

        leftHandIK_Target.localPosition = targetTrasnform.localPosition;
        leftHandIK_Target.localRotation = targetTrasnform.localRotation;
    }
